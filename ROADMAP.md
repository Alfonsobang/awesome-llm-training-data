...
- [x] Publish English README.
- [x] Publish complete Chinese README.
- [x] Add contribution rules and issue templates.
- [x] Add Markdown link checking.
- [x] Add data quality rubric.
- [x] Add financial-domain evaluation checklist.
...
- [x] Turn the Synthetic Financial Evaluation Data Playbook into fixture authoring rules and validator checks.
- [x] Turn the Annotation and Preference Quality page into a review rubric JSON schema.
